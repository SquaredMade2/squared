...
import * as Toolbar from "@squared-ui/react-toolbar";

const {
	contentClass: dropdownMenuContentClass,
	itemClass: dropdownMenuItemClass,
} = classes;
		...
		>
			...
			<DropdownMenu.Root>
				...
				<DropdownMenu.Content
					...
					sideOffset={5}
				>
					<DropdownMenu.Item className={dropdownMenuItemClass()}>
						Undo
					</DropdownMenu.Item>
					<DropdownMenu.Item className={dropdownMenuItemClass()}>
						Redo
