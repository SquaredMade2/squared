...
import * as NavigationMenu from "@squared-ui/react-navigation-menu";
import { DirectionProvider } from "@squared-ui/react-direction";
								...
								<NavigationMenu.List className={mainListClass()}>
									<NavigationMenu.Item value="extensibility">
										<NavigationMenu.Trigger
											className={submenusSubTriggerClass()}
										>
											Extensibility
										</NavigationMenu.Trigger>
									...
									<NavigationMenu.Indicator
										className={submenusSubIndicatorClass()}
									/>
								</NavigationMenu.List>

								<NavigationMenu.Viewport
									className={submenusSubViewportClass()}
								/>
							</NavigationMenu.Sub>
						</NavigationMenu.Content>
					</NavigationMenu.Item>
				...
				<div dir={rtl ? "rtl" : "ltr"}>
					<div
						style={{
							...
							boxShadow:
								"0 50px 100px -20px rgba(50,50,93,0.1),0 30px 60px -30px rgba(0,0,0,0.2)",
						}}
					>
						<button>Logo</button>
						{children}
					...
					>
						...
						<p>
							...
							<a href="#example">sagittis vel nibh</a>. Fusce placerat arcu
							lorem, a scelerisque odio fringilla sit amet. Suspendisse volutpat
							sed diam ut cursus. Nulla facilisi. Ut at volutpat nibh. Nullam
							justo mi, elementum vitae ex eu,{" "}
							<a href="#example">gravida dictum metus</a>. Morbi vulputate
							consectetur cursus. Fusce vitae nisi nunc. Suspendisse
							pellentesque aliquet tincidunt. Aenean molestie pulvinar ipsum.
						</p>
...
const viewportViewportClass = css({
	...
	width: "var(--squared-navigation-menu-viewport-width)",
	height: "var(--squared-navigation-menu-viewport-height)",
