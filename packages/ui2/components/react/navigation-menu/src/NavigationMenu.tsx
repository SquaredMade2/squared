...
import { composeRefs, useComposedRefs } from "@squared-ui/react-compose-refs";
...
import * as VisuallyHiddenPrimitive from "@squared-ui/react-visually-hidden";
	...
	return (
		<Primitive.div
			...
			style={{
				// Prevent interaction when animating out
				pointerEvents: !open && context.isRootMenu ? "none" : undefined,
				["--squared-navigation-menu-viewport-width" as any]: viewportWidth,
				["--squared-navigation-menu-viewport-height" as any]: viewportHeight,
