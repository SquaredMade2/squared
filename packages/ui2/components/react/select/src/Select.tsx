...
import { composeEventHandlers } from "@squared-ui/primitive";
import { createCollection } from "@squared-ui/react-collection";
import { useComposedRefs } from "@squared-ui/react-compose-refs";
import { createContextScope } from "@squared-ui/react-context";
import { useDirection } from "@squared-ui/react-direction";
import { DismissableLayer } from "@squared-ui/react-dismissable-layer";
import { useFocusGuards } from "@squared-ui/react-focus-guards";
import { FocusScope } from "@squared-ui/react-focus-scope";
import { useId } from "@squared-ui/react-id";
import * as PopperPrimitive from "@squared-ui/react-popper";
import { createPopperScope } from "@squared-ui/react-popper";
import { Portal as PortalPrimitive } from "@squared-ui/react-portal";
import { Primitive } from "@squared-ui/react-primitive";
import { Slot } from "@squared-ui/react-slot";
import { useCallbackRef } from "@squared-ui/react-use-callback-ref";
import { useControllableState } from "@squared-ui/react-use-controllable-state";
import { useLayoutEffect } from "@squared-ui/react-use-layout-effect";
import { usePrevious } from "@squared-ui/react-use-previous";
import { VisuallyHidden } from "@squared-ui/react-visually-hidden";
import { hideOthers } from "aria-hidden";
import { RemoveScroll } from "react-remove-scroll";

import type { Scope } from "@squared-ui/react-context";
		...
		<>
			...
			<style
				dangerouslySetInnerHTML={{
					__html: `[data-squared-select-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-squared-select-viewport]::-webkit-scrollbar{display:none}`,
				}}
				nonce={nonce}
			/>
