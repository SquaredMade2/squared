...
import * as Collapsible from "@squared-ui/react-collapsible";
...
export const Styled = () => (
	<Collapsible.Root className={rootClass()}>
		...
		<Collapsible.Content className={contentClass()}>
			Content 1
		</Collapsible.Content>
	</Collapsible.Root>
);
...
export const Chromatic = () => (
	<>
		...
		<Collapsible.Root className={rootAttrClass()}>
			<Collapsible.Trigger className={triggerAttrClass()}>
				Trigger
			</Collapsible.Trigger>
			<Collapsible.Content className={contentAttrClass()}>
				Content 1
			</Collapsible.Content>
		</Collapsible.Root>
