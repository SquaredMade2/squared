...
import * as Menubar from "@squared-ui/react-menubar";
import { css } from "../../../../stitches.config";
import { classes, TickIcon } from "../../menu/src/Menu.stories";
import { foodGroups } from "../../../../test-data/foods";

const { contentClass, itemClass, separatorClass, labelClass, subTriggerClass } =
	classes;
...
export const Styled = () => {
	...
	const [checkedSelection, setCheckedSelection] = React.useState<string[]>([
		checkOptions[1],
	]);
