...
export const SingleItemAsDialogTrigger = () => {
	const dropdownTriggerRef =
		React.useRef<React.ElementRef<typeof DropdownMenu.Trigger>>(null);
				...
				<DropdownMenu.Root modal={false}>
					...
					<DropdownMenu.Portal>
						...
						>
							...
							<Dialog.Trigger asChild className={itemClass()}>
								<DropdownMenu.Item onSelect={() => setDeleteOpen2(true)}>
									Delete
								</DropdownMenu.Item>
							</Dialog.Trigger>
							<DropdownMenu.Arrow />
...
export const Chromatic = () => {
	...
	return (
		<div style={{ padding: 200, paddingBottom: 800 }}>
			...
			<h2>Closed</h2>
			<DropdownMenu.Root open={false} modal={false}>
				<DropdownMenu.Trigger className={triggerAttrClass()}>
					Open
				</DropdownMenu.Trigger>
				<DropdownMenu.Portal>
					<DropdownMenu.Content
