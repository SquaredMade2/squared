...
import { Slottable } from "@squared-ui/react-slot";
		...
		>
			<PopperPrimitive.Content
				...
				style={{
					...
					...{
						"--squared-tooltip-content-transform-origin":
							"var(--squared-popper-transform-origin)",
						"--squared-tooltip-content-available-width":
							"var(--squared-popper-available-width)",
						"--squared-tooltip-content-available-height":
							"var(--squared-popper-available-height)",
						"--squared-tooltip-trigger-width":
							"var(--squared-popper-anchor-width)",
						"--squared-tooltip-trigger-height":
