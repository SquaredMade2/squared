		...
		>
			<PopperPrimitive.Content
				...
				style={{
					...
					...{
						"--squared-hover-card-content-transform-origin":
							"var(--squared-popper-transform-origin)",
						"--squared-hover-card-content-available-width":
							"var(--squared-popper-available-width)",
						"--squared-hover-card-content-available-height":
							"var(--squared-popper-available-height)",
						"--squared-hover-card-trigger-width":
							"var(--squared-popper-anchor-width)",
						"--squared-hover-card-trigger-height":
