...
import * as Dialog from "@squared-ui/react-dialog";
import { SIDE_OPTIONS, ALIGN_OPTIONS } from "@squared-ui/react-popper";
import * as HoverCard from "@squared-ui/react-hover-card";
		...
		>
					...
					<HoverCard.Portal>
						...
						>
							...
							<div style={{ maxWidth: 400 }}>
								Text selections will be contained within the content. While a
								selection is active the content will not dismiss unless the
								selection is cleared or an outside interaction is performed.
							</div>
						</HoverCard.Content>
					</HoverCard.Portal>
				</HoverCard.Root>
							...
							<HoverCard.Root>
								...
								<HoverCard.Portal>
									...
									>
										...
										/>
										<div style={{ maxWidth: 400 }}>
											Text selections will be contained within the content.
											While a selection is active the content will not dismiss
											unless the selection is cleared or an outside interaction
											is performed.
										</div>
										...
										<HoverCard.Root>
											...
											<HoverCard.Portal>
												...
												>
													...
													/>
													<div style={{ maxWidth: 400 }}>
														Text selections will be contained within the
														content. While a selection is active the content
														will not dismiss unless the selection is cleared or
														an outside interaction is performed.
													</div>
												</HoverCard.Content>
											</HoverCard.Portal>
										</HoverCard.Root>
			...
			<div style={{ maxWidth: 800 }}>
				<p>
					...
					feugiat mattis malesuada. Fusce elementum vulputate aliquet. Integer
					fringilla porta eros. Ut ultricies mattis nisi. Sed et tempor massa.
					Sed non arcu ut velit scelerisque bibendum tempor sed mi. In non
					consequat sapien. Donec sollicitudin eget tellus ut venenatis. Donec
					posuere sem ante, nec iaculis arcu varius sit amet. Praesent non
					tortor quam. Curabitur dapibus justo a commodo ornare.
				</p>
				<p>
					Suspendisse eleifend consequat iaculis. Nunc bibendum velit felis, nec
					vulputate purus egestas quis. Integer mauris dui, pulvinar non metus
					id, tristique dignissim elit. Vivamus massa tellus, porttitor id lorem
					non, molestie aliquam dolor. Pellentesque erat quam, pellentesque non
					metus id, tempus sagittis massa.
				</p>
				<p>
					Sed at elementum sem, non venenatis leo. Ut vulputate consectetur
					finibus. Sed nunc lectus, accumsan in nisl et, vehicula pretium nisi.
					Vivamus vestibulum ante quis urna consequat, ultrices condimentum sem
					commodo. Pellentesque eget orci laoreet, feugiat purus sed, maximus
					nisi. Suspendisse commodo venenatis facilisis.
				</p>
			</div>
		</div>
	);
...
const RECOMMENDED_CSS__HOVERCARD__CONTENT = {
	transformOrigin: "var(--squared-hover-card-content-transform-origin)",
};
