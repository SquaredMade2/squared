...
import * as CollapsiblePrimitive from "@squared-ui/react-collapsible";
import { createCollapsibleScope } from "@squared-ui/react-collapsible";
...
>((props: ScopedProps<AccordionContentProps>, forwardedRef) => {
	...
	return (
		<CollapsiblePrimitive.Content
			...
			ref={forwardedRef}
			style={{
				["--squared-accordion-content-height" as any]:
					"var(--squared-collapsible-content-height)",
				["--squared-accordion-content-width" as any]:
