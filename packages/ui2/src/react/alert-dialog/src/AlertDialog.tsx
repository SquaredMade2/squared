...
import * as DialogPrimitive from "@squared-ui/react-dialog";
import { createDialogScope } from "@squared-ui/react-dialog";
...
Alternatively, you can use your own component as a description by assigning it an \`id\` and passing the same value to the \`aria-describedby\` prop in \`${CONTENT_NAME}\`. If the description is confusing or duplicative for sighted users, you can use the \`@squared-ui/react-visually-hidden\` primitive as a wrapper around your description component.

For more information, see https://squared-ui.com/primitives/docs/components/alert-dialog`;
