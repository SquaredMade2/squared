...
import { useSize } from "@squared-ui/react-use-size";
	...
	return (
		...
		>
			<SliderImpl
				...
				style={{
					...sliderProps.style,
					["--squared-slider-thumb-transform" as any]: "translateX(-50%)",
				}}
				onSlideStart={(event) => {
	...
	return (
		...
		>
			<SliderImpl
				...
				style={{
					...sliderProps.style,
					["--squared-slider-thumb-transform" as any]: "translateY(50%)",
				}}
				onSlideStart={(event) => {
...
const SliderThumb = React.forwardRef<SliderThumbElement, SliderThumbProps>(
	(props: ScopedProps<SliderThumbProps>, forwardedRef) => {
		...
		const [thumb, setThumb] = React.useState<SliderThumbImplElement | null>(
			null,
		);
...
>((props: ScopedProps<SliderThumbImplProps>, forwardedRef) => {
	...
	return (
		<span
			style={{
				transform: "var(--squared-slider-thumb-transform)",
				position: "absolute",
