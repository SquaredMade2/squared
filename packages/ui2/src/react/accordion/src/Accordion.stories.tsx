...
import * as Accordion from "@squared-ui/react-accordion";
...
const slideDown = keyframes({
	from: { height: 0 },
	to: { height: "var(--squared-accordion-content-height)" },
});

const slideUp = keyframes({
	from: { height: "var(--squared-accordion-content-height)" },
	to: { height: 0 },
});
...
const open2D = keyframes({
	...
	to: {
		width: "var(--squared-accordion-content-width)",
		height: "var(--squared-accordion-content-height)",
	},
});
