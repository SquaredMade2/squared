import { isArray, isPlainObject } from "@squared/is-what";
...
function assignProp(
	...
	const propType = {}.propertyIsEnumerable.call(originalObject, key)
		? "enumerable"
		: "nonenumerable";
	if (propType === "enumerable") carry[key as keyof PlainObject] = newVal;
...
export function copy<T>(target: T, options: Options = {}): T {
	...
	// biome-ignore lint/suspicious/noExplicitAny: Target can be anything
