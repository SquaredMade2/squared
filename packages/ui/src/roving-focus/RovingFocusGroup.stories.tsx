...
type RovingFocusGroupProps = React.ComponentProps<typeof RovingFocusGroup.RovingFocusGroup>;
...
const Button = (props: ButtonProps) => {
  ...
  return (
    <RovingFocusGroup.RovingFocusGroupItem asChild active={isSelected} focusable={!props.disabled}>
      <button
        {...props}
        style={{
          ...props.style,
