...
export const Styled = () => (
  ...
  >
    <DropdownMenuPrimitive.Root>
      <DropdownMenuPrimitive.Trigger className={triggerClass()}>Open</DropdownMenuPrimitive.Trigger>
      <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content className={contentClass()} sideOffset={5}>
          <DropdownMenuPrimitive.Item className={itemClass()} onSelect={() => console.log('undo')}>
            Undo
          </DropdownMenuPrimitive.Item>
          <DropdownMenuPrimitive.Item className={itemClass()} onSelect={() => console.log('redo')}>
            Redo
          </DropdownMenuPrimitive.Item>
          ...
          <DropdownMenuPrimitive.Item className={itemClass()} onSelect={() => console.log('copy')}>
            Copy
          </DropdownMenuPrimitive.Item>
          <DropdownMenuPrimitive.Item className={itemClass()} onSelect={() => console.log('paste')}>
            Paste
          </DropdownMenuPrimitive.Item>
        ...
        <DropdownMenuPrimitive.Root dir={rtl ? 'rtl' : 'ltr'}>
          ...
          <DropdownMenuPrimitive.Portal>
            <DropdownMenuPrimitive.Content className={contentClass()} sideOffset={5}>
              ...
              <DropdownMenuPrimitive.Sub>
                <DropdownMenuPrimitive.SubTrigger className={subTriggerClass()} disabled>
                  History →
                </DropdownMenuPrimitive.SubTrigger>
                <DropdownMenuPrimitive.Portal>
                  <DropdownMenuPrimitive.SubContent
        ...
        <DropdownMenuPrimitive.Content className={contentClass()} sideOffset={5}>
          {foodGroups.map((foodGroup, index) => (
            <DropdownMenuPrimitive.Group key={index}>
              {foodGroup.label && (
                <DropdownMenuPrimitive.Label className={labelClass()} key={foodGroup.label}>
                  {foodGroup.label}
          ...
          <DropdownMenuPrimitive.Content className={contentClass()} sideOffset={5}>
            <DialogPrimitive.Root>
              <DialogPrimitive.Trigger className={itemClass()} asChild>
                <DropdownMenuPrimitive.Item onSelect={(event) => event.preventDefault()}>
                  Open dialog
                </DropdownMenuPrimitive.Item>
            ...
            <DropdownMenuPrimitive.Item className={itemClass()}>Test</DropdownMenuPrimitive.Item>
            <DropdownMenuPrimitive.Arrow />
          </DropdownMenuPrimitive.Content>
        </DropdownMenuPrimitive.Portal>
      </DropdownMenuPrimitive.Root>
...
export const SingleItemAsDialogTrigger = () => {
  ...
  return (
    ...
    >
      ...
      <DialogPrimitive.Root>
        <DropdownMenuPrimitive.Root>
          <DropdownMenuPrimitive.Trigger className={triggerClass()} ref={dropdownTriggerRef}>
            Open
          </DropdownMenuPrimitive.Trigger>
      ...
      <DialogPrimitive.Root modal={false}>
        <DropdownMenuPrimitive.Root modal={false}>
          <DropdownMenuPrimitive.Trigger className={triggerClass()} ref={dropdownTriggerRef2}>
            Open
          </DropdownMenuPrimitive.Trigger>
          ...
          <DropdownMenuPrimitive.Portal>
            ...
            >
              <DialogPrimitive.Trigger className={itemClass()} asChild>
                <DropdownMenuPrimitive.Item onSelect={() => (isDialogOpenRef.current = true)}>
                  Delete
                </DropdownMenuPrimitive.Item>
              </DialogPrimitive.Trigger>
              <DropdownMenuPrimitive.Item className={itemClass()}>Test</DropdownMenuPrimitive.Item>
  ...
  return (
    ...
    >
      ...
      >
          ...
          <DropdownMenuPrimitive.Portal>
            <DropdownMenuPrimitive.Content className={contentClass()} sideOffset={5}>
              <DialogPrimitive.Trigger asChild className={itemClass()}>
                <DropdownMenuPrimitive.Item onSelect={() => setSwitchAccountsOpen(true)}>
                  Switch Accounts
                </DropdownMenuPrimitive.Item>
              </DialogPrimitive.Trigger>
              <DialogPrimitive.Trigger asChild className={itemClass()}>
                <DropdownMenuPrimitive.Item onSelect={() => setDeleteOpen(true)}>
                  Delete
                </DropdownMenuPrimitive.Item>
              </DialogPrimitive.Trigger>
              <DropdownMenuPrimitive.Arrow />
        ...
        >
          {switchAccountsOpen && <DialogPrimitive.Title>Switch accounts</DialogPrimitive.Title>}
          {deleteOpen && <DialogPrimitive.Title>Are you sure?</DialogPrimitive.Title>}
          <DialogPrimitive.Close>Close</DialogPrimitive.Close>
        </DialogPrimitive.Content>
      </DialogPrimitive.Root>
      ...
      >
        <DropdownMenuPrimitive.Root modal={false}>
          ...
          <DropdownMenuPrimitive.Portal>
            ...
            >
              <DialogPrimitive.Trigger asChild className={itemClass()}>
                <DropdownMenuPrimitive.Item onSelect={() => setSwitchAccountsOpen2(true)}>
                  Switch Accounts
                </DropdownMenuPrimitive.Item>
              </DialogPrimitive.Trigger>
              <DialogPrimitive.Trigger asChild className={itemClass()}>
                <DropdownMenuPrimitive.Item onSelect={() => setDeleteOpen2(true)}>
                  Delete
                </DropdownMenuPrimitive.Item>
              </DialogPrimitive.Trigger>
              <DropdownMenuPrimitive.Arrow />
        ...
        >
          {switchAccountsOpen2 && <DialogPrimitive.Title>Switch accounts</DialogPrimitive.Title>}
          {deleteOpen2 && <DialogPrimitive.Title>Are you sure?</DialogPrimitive.Title>}
          <DialogPrimitive.Close>Close</DialogPrimitive.Close>
        </DialogPrimitive.Content>
      </DialogPrimitive.Root>
    </div>
      ...
      <DropdownMenuPrimitive.Root>
        ...
        <DropdownMenuPrimitive.Portal>
          <DropdownMenuPrimitive.Content className={contentClass()} sideOffset={5}>
            ...
            <DropdownMenuPrimitive.Separator className={separatorClass()} />
            <DropdownMenuPrimitive.RadioGroup value={file} onValueChange={setFile}>
              {files.map((file) => (
                <DropdownMenuPrimitive.RadioItem key={file} className={itemClass()} value={file}>
                  {file}
                  <DropdownMenuPrimitive.ItemIndicator>
                    <TickIcon />
                  </DropdownMenuPrimitive.ItemIndicator>
      ...
      <div className={gridClass()}>
        {SIDES.map((side) =>
          ALIGN_OPTIONS.map((align) => (
            <DropdownMenuPrimitive.Root key={`${side}-${align}`} open modal={false}>
              <DropdownMenuPrimitive.Trigger className={chromaticTriggerClass()} />
              <DropdownMenuPrimitive.Portal>
                <DropdownMenuPrimitive.Content
        ...
        >
          <DialogPrimitive.Root open modal={false}>
            ...
            >
              ...
              <DropdownMenuPrimitive.Root open modal={false}>
                <DropdownMenuPrimitive.Trigger className={triggerClass()} style={{ width: '100%' }}>
                  Open
                </DropdownMenuPrimitive.Trigger>
                <DropdownMenuPrimitive.Portal>
                  <DropdownMenuPrimitive.Content
        ...
        <DropdownMenuPrimitive.Portal>
          ...
          >
            ...
            {checkboxItems.map(({ label, state: [checked, setChecked], disabled }) => (
              ...
              >
                {label}
                <DropdownMenuPrimitive.ItemIndicator className={itemIndicatorAttrClass()}>
                  <TickIcon />
                </DropdownMenuPrimitive.ItemIndicator>
              </DropdownMenuPrimitive.CheckboxItem>
            ))}
