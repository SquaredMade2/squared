    ...
    return (
      <MenuPrimitive.Content
        ...
        style={{
          ...
          ...{
            '--sandy-dropdown-menu-content-transform-origin':
              'var(--sandy-popper-transform-origin)',
            '--sandy-dropdown-menu-content-available-width': 'var(--sandy-popper-available-width)',
            '--sandy-dropdown-menu-content-available-height':
              'var(--sandy-popper-available-height)',
            '--sandy-dropdown-menu-trigger-width': 'var(--sandy-popper-anchor-width)',
            '--sandy-dropdown-menu-trigger-height': 'var(--sandy-popper-anchor-height)',
          },
        }}
      />
    );
  ...
  return (
    <MenuPrimitive.SubContent
      ...
      style={{
        ...
        // re-namespace exposed content custom properties
        ...{
          '--sandy-dropdown-menu-content-transform-origin': 'var(--sandy-popper-transform-origin)',
          '--sandy-dropdown-menu-content-available-width': 'var(--sandy-popper-available-width)',
          '--sandy-dropdown-menu-content-available-height': 'var(--sandy-popper-available-height)',
          '--sandy-dropdown-menu-trigger-width': 'var(--sandy-popper-anchor-width)',
          '--sandy-dropdown-menu-trigger-height': 'var(--sandy-popper-anchor-height)',
        },
      }}
