...
const ToastUpgradeAvailable = (props: React.ComponentProps<typeof Toast.Root>) => (
  <Toast.Root className={rootClass()} {...props}>
    ...
    <Toast.Description className={descriptionClass()}>
      We've just released Sandy version 3.0
    </Toast.Description>
    <Toast.Action
...
const slideRight = keyframes({
  from: { transform: 'translateX(var(--sandy-toast-swipe-end-x))' },
...
const slideUp = keyframes({
  from: { transform: 'translateY(var(--sandy-toast-swipe-end-y))' },
  to: {
...
const animatedRootClass = css(rootClass, {
  ...
  '&[data-swipe="move"]': {
    transform: 'translate(var(--sandy-toast-swipe-move-x), var(--sandy-toast-swipe-move-y))',
  },
  '&[data-swipe="cancel"]': {
