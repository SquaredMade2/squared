      ...
      <Presence present={forceMount || open}>
        <ToastImpl
          ...
          onSwipeMove={composeEventHandlers(props.onSwipeMove, (event) => {
            ...
            event.currentTarget.style.setProperty('--sandy-toast-swipe-move-x', `${x}px`);
            event.currentTarget.style.setProperty('--sandy-toast-swipe-move-y', `${y}px`);
          })}
          onSwipeCancel={composeEventHandlers(props.onSwipeCancel, (event) => {
            event.currentTarget.setAttribute('data-swipe', 'cancel');
            event.currentTarget.style.removeProperty('--sandy-toast-swipe-move-x');
            event.currentTarget.style.removeProperty('--sandy-toast-swipe-move-y');
            event.currentTarget.style.removeProperty('--sandy-toast-swipe-end-x');
            event.currentTarget.style.removeProperty('--sandy-toast-swipe-end-y');
          })}
          onSwipeEnd={composeEventHandlers(props.onSwipeEnd, (event) => {
            ...
            event.currentTarget.style.removeProperty('--sandy-toast-swipe-move-x');
            event.currentTarget.style.removeProperty('--sandy-toast-swipe-move-y');
            event.currentTarget.style.setProperty('--sandy-toast-swipe-end-x', `${x}px`);
            event.currentTarget.style.setProperty('--sandy-toast-swipe-end-y', `${y}px`);
            setOpen(false);
          })}
        />
      </Presence>
...
const ToastImpl = React.forwardRef<ToastImplElement, ToastImplProps>(
  (props: ScopedProps<ToastImplProps>, forwardedRef) => {
    ...
    }, [context.viewport, onPause, onResume, startTimer]);
...
>((props: ScopedProps<ToastAnnounceExcludeProps>, forwardedRef) => {
  ...
  return (
    <Primitive.div
      data-sandy-toast-announce-exclude=""
      data-sandy-toast-announce-alt={altText || undefined}
...
function getAnnounceTextContent(container: HTMLElement) {
  ...
  childNodes.forEach((node) => {
    ...
    if (isHTMLElement(node)) {
      ...
      const isExcluded = node.dataset.sandyToastAnnounceExclude === '';

      if (!isHidden) {
        if (isExcluded) {
          const altText = node.dataset.sandyToastAnnounceAlt;
