...
const [Collection, useCollection, createCollectionScope] =
  createCollection<MenuItemElement, ItemData>(MENU_NAME);
...
const Menu: React.FC<MenuProps> = (props: ScopedProps<MenuProps>) => {
  ...
  const [content, setContent] =
    React.useState<MenuContentElement | null>(null);
...
type MenuContentImplElement = React.ElementRef<
  typeof PopperPrimitive.PopperContent
>;
...
>((props: ScopedProps<MenuContentImplProps>, forwardedRef) => {
  ...
  const pointerGraceIntentRef = React.useRef<GraceIntent | null>(
    null
  );
...
type MenuArrowElement = React.ElementRef<
  typeof PopperPrimitive.PopperArrow
>;
...
const MenuSub: React.FC<MenuSubProps> = (
  ...
  const [trigger, setTrigger] =
    React.useState<MenuSubTriggerElement | null>(null);
  const [content, setContent] =
    React.useState<MenuContentElement | null>(null);
  const handleOpenChange = useCallbackRef(onOpenChange);
