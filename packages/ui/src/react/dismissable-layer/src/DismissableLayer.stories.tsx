...
import * as Popper from "@squared-ui/react-popper";
import { Portal } from "@squared-ui/react-portal";
import { FocusGuards } from "@squared-ui/react-focus-guards";
...
export const DialogExample = () => (
	<div style={{ height: "300vh", fontFamily: SYSTEM_FONT }}>
		...
		<ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
			...
			<li>
				✅ interacting outside `Dialog` should be disabled (clicking the "alert
				me" button shouldn't do anything)
			</li>
			<li>➕</li>
...
export const PopoverFullyModal = () => (
	<div style={{ height: "300vh", fontFamily: SYSTEM_FONT }}>
		...
		<ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
			...
			<li>
				✅ interacting outside `Popover` should be disabled (clicking the "alert
				me" button shouldn't do anything)
			</li>
			<li>➕</li>
	...
	return (
		<div style={{ height: "300vh", fontFamily: SYSTEM_FONT }}>
			...
			<ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
				...
				<li style={{ marginLeft: 30 }}>
					✅ focus should <span style={{ fontWeight: 600 }}>NOT</span> return to
					the open button when unmounted, natural focus should occur
				</li>
			</ul>
...
export const PopoverNonModal = () => (
	<div style={{ height: "300vh", fontFamily: SYSTEM_FONT }}>
		...
		<ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
			<li>✅ focus should move inside `Popover` when mounted</li>
			<li>
				✅ focus should <span style={{ fontWeight: 600 }}>NOT</span> be trapped
				inside `Popover`
			</li>
			<li>✅ scrolling outside `Popover` should be allowed</li>
			<li>✅ should be able to dismiss `Popover` on pressing escape</li>
			...
			<li>
				✅ interacting outside `Popover` should be allowed (clicking the "alert
				me" button should trigger)
			</li>
			<li>➕</li>
...
export const PopoverNested = () => (
	<div style={{ height: "300vh", fontFamily: SYSTEM_FONT }}>
		...
		<ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
			...
			<li>
				✅ interacting outside the blue `Popover` should only dismiss itself and
				not its parents
			</li>
			<li>
			...
			<li>
				...
				<span style={{ fontWeight: 600 }}>NO</span> text cursor above the red or
				black inputs
			</li>
			<li>
