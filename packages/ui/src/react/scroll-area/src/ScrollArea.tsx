		...
		<>
			<style
				dangerouslySetInnerHTML={{
					__html: `
[data-squared-scroll-area-viewport] {
  scrollbar-width: none;
  -ms-overflow-style: none;
  -webkit-overflow-scrolling: touch;
}
[data-squared-scroll-area-viewport]::-webkit-scrollbar {
  display: none;
}
:where([data-squared-scroll-area-viewport]) {
  display: flex;
  flex-direction: column;
  align-items: stretch;
}
:where([data-squared-scroll-area-content]) {
  flex-grow: 1;
}
`,
				}}
			...
			>
				{getSubtree({ asChild, children }, (children) => (
					<div
						data-squared-scroll-area-content=""
...
>((props: ScopedProps<ScrollAreaThumbImplProps>, forwardedRef) => {
	...
	return (
		<Primitive.div
			...
			ref={composedRef}
			style={{
				width: "var(--squared-scroll-area-thumb-width)",
				height: "var(--squared-scroll-area-thumb-height)",
				...style,
			}}
