...
export function ModifiersProvider(props: ModifiersProviderProps): JSX.Element {
  ...
  const customModifiers: CustomModifiers = getCustomModifiers(dayPicker.modifiers);
  ...
  return <ModifiersContext.Provider value={modifiers}>{props.children}</ModifiersContext.Provider>;
}
