...
import { getNextFocus, MoveFocusBy, MoveFocusDirection } from './utils/getNextFocus';
...
export function FocusProvider(props: FocusProviderProps): JSX.Element {
  ...
  const initialFocusTarget = getInitialFocusTarget(navigation.displayMonths, modifiers);
