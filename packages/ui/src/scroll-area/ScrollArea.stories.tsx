...
const ScrollAreaStory = ({
  ...
  >
    <ScrollAreaPrimitive.Viewport className={scrollAreaViewportClass()}>
      {children}
    </ScrollAreaPrimitive.Viewport>
    {vertical && (
      <ScrollAreaPrimitive.Scrollbar className={scrollbarClass()} orientation="vertical">
        <ScrollAreaPrimitive.Thumb className={animated ? animatedThumbClass() : thumbClass()} />
      </ScrollAreaPrimitive.Scrollbar>
    )}
    {horizontal && (
      <ScrollAreaPrimitive.Scrollbar className={scrollbarClass()} orientation="horizontal">
        <ScrollAreaPrimitive.Thumb className={animated ? animatedThumbClass() : thumbClass()} />
      </ScrollAreaPrimitive.Scrollbar>
    )}
