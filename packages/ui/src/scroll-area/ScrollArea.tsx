      ...
      >
        <Primitive.div
          ...
          style={{
            ...
            ['--sandy-scroll-area-corner-width' as any]: cornerWidth + 'px',
            ['--sandy-scroll-area-corner-height' as any]: cornerHeight + 'px',
            ...props.style,
          }}
        />
      </ScrollAreaProvider>
      ...
      <>
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `[data-sandy-scroll-area-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-sandy-scroll-area-viewport]::-webkit-scrollbar{display:none}`,
          }}
          nonce={nonce}
        />
        <Primitive.div
          data-sandy-scroll-area-viewport=""
          {...viewportProps}
          ref={composedRefs}
          style={{
            /**
...
>((props: ScopedProps<ScrollAreaScrollbarAxisProps>, forwardedRef) => {
  ...
  return (
    <ScrollAreaScrollbarImpl
      ...
      style={{
        bottom: 0,
        left: context.dir === 'rtl' ? 'var(--sandy-scroll-area-corner-width)' : 0,
        right: context.dir === 'ltr' ? 'var(--sandy-scroll-area-corner-width)' : 0,
        ['--sandy-scroll-area-thumb-width' as any]: getThumbSize(sizes) + 'px',
        ...props.style,
      }}
  ...
  return (
    <ScrollAreaScrollbarImpl
      ...
      style={{
        ...
        bottom: 'var(--sandy-scroll-area-corner-height)',
        ['--sandy-scroll-area-thumb-height' as any]: getThumbSize(sizes) + 'px',
        ...props.style,
      }}
  ...
  (props: ScopedProps<ScrollAreaThumbImplProps>, forwardedRef) => {
    ...
    return (
      <Primitive.div
        ...
        ref={composedRef}
        style={{
          width: 'var(--sandy-scroll-area-thumb-width)',
          height: 'var(--sandy-scroll-area-thumb-height)',
          ...style,
        }}
