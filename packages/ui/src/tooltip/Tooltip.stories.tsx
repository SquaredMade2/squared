...
export const Styled = () => (
  <Tooltip.TooltipProvider>
    <Tooltip.Tooltip>
      <Tooltip.TooltipTrigger className={triggerClass()}>Hover or Focus me</Tooltip.TooltipTrigger>
...
export const CustomDurations = () => (
  <Tooltip.TooltipProvider>
    ...
    <div style={{ display: 'flex', gap: 50 }}>
      <Tooltip.Tooltip>
        <Tooltip.TooltipTrigger className={triggerClass()}>Hover me</Tooltip.TooltipTrigger>
        <Tooltip.TooltipPortal>
          <Tooltip.TooltipContent className={contentClass()} sideOffset={5}>
            Nicely done!
            <Tooltip.TooltipArrow className={arrowClass()} offset={10} />
  ...
  return (
    <Tooltip.TooltipProvider>
      <SimpleTooltip label="Save document" side="bottom" align="end">
        <Tooltip.TooltipTrigger ref={buttonRef} type="button" style={{ margin: 100 }}>
          Save
        </Tooltip.TooltipTrigger>
      </SimpleTooltip>
    </Tooltip.TooltipProvider>
  ...
  return (
    <Tooltip.TooltipProvider>
      ...
      <SimpleTooltip label="tooltip 1">
        <Tooltip.TooltipTrigger style={{ alignSelf: 'flex-start', margin: '0vmin' }}>
          Tool 1
        </Tooltip.TooltipTrigger>
      </SimpleTooltip>
    ...
    <Tooltip.TooltipProvider>
      <div style={{ padding: 100 }}>
        <SimpleTooltip className={animatedContentClass()} label="Hello world 1">
          <Tooltip.TooltipTrigger style={{ marginRight: 10 }}>Hello 1</Tooltip.TooltipTrigger>
        </SimpleTooltip>
...
export const Chromatic = () => (
  <Tooltip.TooltipProvider>
    <div style={{ padding: 200 }}>
      ...
      <h2>Closed</h2>
      <Tooltip.Tooltip>
        <Tooltip.TooltipTrigger className={triggerClass()}>open</Tooltip.TooltipTrigger>
        <Tooltip.TooltipPortal>
          <Tooltip.TooltipContent className={contentClass()} sideOffset={5}>
            Some content
            <Tooltip.TooltipArrow className={arrowClass()} offset={10} />
            ...
            <Tooltip.Tooltip key={`${side}-${align}`} open>
              ...
              <Tooltip.TooltipPortal>
                ...
                >
                  ...
                  <Tooltip.TooltipArrow className={chromaticArrowClass()} width={20} height={10} />
                </Tooltip.TooltipContent>
              </Tooltip.TooltipPortal>
            </Tooltip.Tooltip>
          )),
      ...
      {SIDES.map((side) =>
        ALIGN_OPTIONS.map((align) => (
          <Tooltip.Tooltip key={`${side}-${align}`} open>
            ...
            />
            <Tooltip.TooltipPortal>
              <Tooltip.TooltipContent className={chromaticContentClass()} side={side} align={align}>
                <p style={{ textAlign: 'center' }}>
                  {side}
                  <br />
                  {align}
      ...
      <Tooltip.Tooltip open>
        ...
        <Tooltip.TooltipPortal>
          <Tooltip.TooltipContent className={contentClass()} sideOffset={5}>
            Some content
            <Tooltip.TooltipArrow className={arrowClass()} width={20} height={10} offset={10} />
          </Tooltip.TooltipContent>
        </Tooltip.TooltipPortal>
      </Tooltip.Tooltip>
...
const RECOMMENDED_CSS__TOOLTIP__CONTENT: any = {
  transformOrigin: 'var(--sandy-tooltip-content-transform-origin)',
