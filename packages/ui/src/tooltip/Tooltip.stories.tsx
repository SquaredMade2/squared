        ...
        <Tooltip.TooltipPortal>
          ...
          >
            <article>
              ...
              elit. Harum, quae qui. Magnam delectus ex totam repellat
              amet distinctio unde, porro architecto voluptatibus nemo
              et nisi, voluptatem eligendi earum autem fugit.
            </article>
            <Tooltip.TooltipArrow
              className={arrowClass()}
              offset={10}
...
export const AriaLabel = () => (
  <Tooltip.TooltipProvider>
    ...
    <p>
      The second button will display the label, but enunciate the aria
      label.
    </p>
      ...
      {isMounted && (
        <SimpleTooltip label="tooltip 2">
          <Tooltip.TooltipTrigger
            style={{ alignSelf: "flex-start", margin: "0vmin" }}
            onKeyDown={(event) =>
              event.key === "Escape" && setIsMounted(false)
            }
          >
            Tool 2
          </Tooltip.TooltipTrigger>
...
const SIDES: Side[] = [
  ...SIDE_OPTIONS.filter(
    (
      side
    ): side is Exclude<(typeof SIDE_OPTIONS)[number], "bottom"> =>
      side !== "bottom"
  ),
  "bottom",
];
...
export const Chromatic = () => (
  <Tooltip.TooltipProvider>
    <div style={{ padding: 200 }}>
      ...
      <h1 style={{ marginTop: 100, marginBottom: 60 }}>
