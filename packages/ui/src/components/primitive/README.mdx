...
The Primitive component is a foundational building block in the @squared/ui library. It provides a set of basic HTML elements with enhanced functionality, including the ability to render as a child component and forward refs.
