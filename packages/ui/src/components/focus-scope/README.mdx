...
The FocusScope component is a part of the @squaredmade/ui package. It provides advanced focus management capabilities for React applications, allowing developers to control and manipulate focus behavior within specific areas of their user interface.
...
To use the FocusScope component, ensure you have the @squaredmade/ui package installed in your project:
