...
The RovingFocusGroup component is a part of the @squaredmade/ui package, providing an accessible way to manage focus within a group of elements. It's particularly useful for creating keyboard-navigable interfaces such as menus, toolbars, and tab lists.
...
To use the RovingFocusGroup component, ensure you have the @squaredmade/ui package installed in your project:
...
} from '@squaredmade/ui/roving-focus-group';
