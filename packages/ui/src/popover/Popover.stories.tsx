  ...
  return (
    ...
    >
      <PopoverPrimitive.Popover>
        <PopoverPrimitive.Trigger className={triggerClass()}>open</PopoverPrimitive.Trigger>
        <PopoverPrimitive.Portal>
          <PopoverPrimitive.Content className={contentClass()} sideOffset={5}>
            <PopoverPrimitive.Close className={closeClass()}>close</PopoverPrimitive.Close>
            <PopoverPrimitive.Arrow className={arrowClass()} width={20} height={10} />
...
// Original issue: https://github.com/THEjacob1000/sandy-ui/issues/2128
        ...
        <PopoverPrimitive.Portal>
          <PopoverPrimitive.Content
            style={{
              ...
              width: 'var(--sandy-popper-available-width)',
              height: 'var(--sandy-popper-available-height)',
            }}
            sideOffset={5}
  ...
  return (
    ...
    >
      <PopoverPrimitive.Popover>
        <PopoverPrimitive.Trigger className={triggerClass()}>open</PopoverPrimitive.Trigger>
        <PopoverPrimitive.Portal>
          <PopoverPrimitive.Content className={animatedContentClass()} sideOffset={10}>
            <PopoverPrimitive.Close className={closeClass()}>close</PopoverPrimitive.Close>
            <PopoverPrimitive.Arrow className={arrowClass()} width={20} height={10} />
          </PopoverPrimitive.Content>
        </PopoverPrimitive.Portal>
      ...
      <PopoverPrimitive.Popover>
        ...
        <PopoverPrimitive.Portal>
          ...
          >
            ...
            <PopoverPrimitive.Close className={closeClass()} style={{ marginLeft: 10 }}>
              close
...
export const CustomAnchor = () => (
  <PopoverPrimitive.Popover>
    ...
    >
      Item <PopoverPrimitive.Trigger className={triggerClass()}>open</PopoverPrimitive.Trigger>
    </PopoverPrimitive.Anchor>
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        className={contentClass()}
  ...
  return (
    <PopoverPrimitive.Popover>
      ...
      <PopoverPrimitive.Portal>
        <PopoverPrimitive.Content className={contentClass()} sideOffset={5}>
          <PopoverPrimitive.Close className={closeClass()}>close</PopoverPrimitive.Close>
          <PopoverPrimitive.Arrow className={arrowClass()} width={20} height={10} offset={10} />
        </PopoverPrimitive.Content>
      </PopoverPrimitive.Portal>
    </PopoverPrimitive.Popover>
  );
...
export const Chromatic = () => (
  <div style={{ padding: 200, paddingBottom: 500 }}>
          ...
          <PopoverPrimitive.Popover key={`${side}-${align}`} open>
            ...
            <PopoverPrimitive.Portal>
              ...
              >
                ...
                <PopoverPrimitive.Arrow className={chromaticArrowClass()} width={20} height={10} />
              </PopoverPrimitive.Content>
            </PopoverPrimitive.Portal>
          </PopoverPrimitive.Popover>
        )),
    ...
    {SIDES.map((side) =>
      ALIGN_OPTIONS.map((align) => (
        <PopoverPrimitive.Popover key={`${side}-${align}`} open>
          ...
          />
          <PopoverPrimitive.Portal>
            <PopoverPrimitive.Content className={chromaticContentClass()} side={side} align={align}>
              <p style={{ textAlign: 'center' }}>
                {side}
                <br />
                {align}
    ...
    <h2>Closed</h2>
    <PopoverPrimitive.Popover open={false}>
      <PopoverPrimitive.Trigger className={triggerAttrClass()}>open</PopoverPrimitive.Trigger>
      <PopoverPrimitive.Portal>
        <PopoverPrimitive.Content
          ...
          avoidCollisions={false}
        >
          <PopoverPrimitive.Close className={closeAttrClass()}>close</PopoverPrimitive.Close>
          <PopoverPrimitive.Arrow className={arrowAttrClass()} width={20} height={10} />
        </PopoverPrimitive.Content>
      </PopoverPrimitive.Portal>
    </PopoverPrimitive.Popover>
...
const RECOMMENDED_CSS__POPOVER__CONTENT = {
  transformOrigin: 'var(--sandy-popover-content-transform-origin)',
};
