    ...
    >
      <PopoverPrimitive.Popover>
        ...
        <PopoverPrimitive.Portal>
          ...
          >
            out of bound out of bound out of bound out of bound out of
            bound out of bound out of bound out of bound out of bound
          </PopoverPrimitive.Content>
        </PopoverPrimitive.Portal>
      </PopoverPrimitive.Popover>
    </div>
...
const filteredSides: Side[] = SIDE_OPTIONS.filter(
  (side) => side !== "bottom"
);
...
export const Chromatic = () => (
  <div style={{ padding: 200, paddingBottom: 500 }}>
    ...
    <PopoverPrimitive.Popover open>
      <PopoverPrimitive.Anchor
        style={{ padding: 20, background: "gainsboro" }}
      >
        <PopoverPrimitive.Trigger className={triggerClass()}>
          open
        </PopoverPrimitive.Trigger>
