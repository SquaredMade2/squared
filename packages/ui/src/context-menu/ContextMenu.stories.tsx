  ...
  >
    <ContextMenuPrimitive.Root>
      ...
      <ContextMenuPrimitive.Portal>
        <ContextMenuPrimitive.Content className={contentClass()} alignOffset={-5}>
          <ContextMenuPrimitive.Item className={itemClass()} onSelect={() => console.log('undo')}>
            Undo
          </ContextMenuPrimitive.Item>
          <ContextMenuPrimitive.Item className={itemClass()} onSelect={() => console.log('redo')}>
            Redo
          </ContextMenuPrimitive.Item>
          ...
          <ContextMenuPrimitive.Item className={itemClass()} onSelect={() => console.log('copy')}>
            Copy
          </ContextMenuPrimitive.Item>
          <ContextMenuPrimitive.Item className={itemClass()} onSelect={() => console.log('paste')}>
            Paste
          </ContextMenuPrimitive.Item>
        ...
        <ContextMenuPrimitive.Root dir={rtl ? 'rtl' : 'ltr'}>
          ...
          <ContextMenuPrimitive.Portal>
            <ContextMenuPrimitive.Content className={contentClass()}>
              ...
              <ContextMenuPrimitive.Sub>
                <ContextMenuPrimitive.SubTrigger className={subTriggerClass()} disabled>
                  History →
                </ContextMenuPrimitive.SubTrigger>
                <ContextMenuPrimitive.Portal>
                  <ContextMenuPrimitive.SubContent
        ...
        <ContextMenuPrimitive.Content className={contentClass()} alignOffset={-5}>
          {foodGroups.map((foodGroup, index) => (
            <ContextMenuPrimitive.Group key={index}>
              {foodGroup.label && (
                <ContextMenuPrimitive.Label className={labelClass()} key={foodGroup.label}>
                  {foodGroup.label}
  ...
  return (
    <div style={{ textAlign: 'center', padding: 50 }}>
      <ContextMenuPrimitive.Root>
        ...
        <ContextMenuPrimitive.Portal>
          <ContextMenuPrimitive.Content className={contentClass()} alignOffset={-5}>
            <ContextMenuPrimitive.Item className={itemClass()} onSelect={() => console.log('show')}>
              Show fonts
            </ContextMenuPrimitive.Item>
            <ContextMenuPrimitive.Item
              className={itemClass()}
      ...
      <ContextMenuPrimitive.Root>
        ...
        <ContextMenuPrimitive.Portal>
          <ContextMenuPrimitive.Content className={contentClass()} alignOffset={-5}>
            ...
            <ContextMenuPrimitive.Item className={itemClass()} onSelect={() => console.log('zoom')}>
              Zoom
            </ContextMenuPrimitive.Item>
            <ContextMenuPrimitive.Item
              className={itemClass()}
            ...
            <ContextMenuPrimitive.Separator className={separatorClass()} />
            <ContextMenuPrimitive.RadioGroup value={file} onValueChange={setFile}>
              {files.map((file) => (
                <ContextMenuPrimitive.RadioItem key={file} className={itemClass()} value={file}>
                  {file}
                  <ContextMenuPrimitive.ItemIndicator>
                    <TickIcon />
                  </ContextMenuPrimitive.ItemIndicator>
      ...
      {Array.from({ length: 100 }, (_, i) => {
        ...
        return (
          <ContextMenuPrimitive.Root key={i}>
            <ContextMenuPrimitive.Portal>
              <ContextMenuPrimitive.Content className={animatedContentClass()} alignOffset={-5}>
                ...
                >
                  <ContextMenuPrimitive.RadioItem className={itemClass()} value="royalblue">
                    Blue
                    <ContextMenuPrimitive.ItemIndicator>
                      <TickIcon />
                    </ContextMenuPrimitive.ItemIndicator>
                  </ContextMenuPrimitive.RadioItem>
                  <ContextMenuPrimitive.RadioItem className={itemClass()} value="tomato">
                    Red
                    <ContextMenuPrimitive.ItemIndicator>
                      <TickIcon />
                    </ContextMenuPrimitive.ItemIndicator>
...
const animatedContentClass = css(contentClass, {
  transformOrigin: 'var(--sandy-context-menu-content-transform-origin)',
  '&[data-state="open"]': {
