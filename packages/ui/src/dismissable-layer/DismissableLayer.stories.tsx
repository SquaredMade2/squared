...
type DismissableLayerProps = React.ComponentProps<
...
export const Basic = () => {
  ...
  const [
    ...
    setDismissOnPointerDownOutside,
      ...
      >
        <label style={{ display: "block" }}>
          <input
            ...
            onChange={(event) =>
              setDismissOnEscape(event.target.checked)
            }
          />{" "}
          Dismiss on escape?
        </label>
        ...
        <label style={{ display: "block" }}>
          <input
            ...
            onChange={(event) =>
              setDismissOnFocusOutside(event.target.checked)
            }
          />{" "}
...
export const DialogExample = () => (
  <div style={{ height: "300vh", fontFamily: SYSTEM_FONT }}>
    ...
    <ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
      ...
      <li>
        ✅ interacting outside `Dialog` should be disabled (clicking
        the "alert me" button shouldn't do anything)
      </li>
      <li>➕</li>
      <li>
...
export const PopoverFullyModal = () => (
  <div style={{ height: "300vh", fontFamily: SYSTEM_FONT }}>
    ...
    <ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
      ...
      <li>
        ✅ interacting outside `Popover` should be disabled (clicking
        the "alert me" button shouldn't do anything)
      </li>
      <li>➕</li>
      <li>
        ✅ should be able to dismiss `Popover` when interacting
        outside
      </li>
      <li style={{ marginLeft: 30 }}>
        ✅ focus should return to the open button
  ...
  return (
    <div style={{ height: "300vh", fontFamily: SYSTEM_FONT }}>
      ...
      <ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
        ...
        <li>
          ✅ interacting outside `Popover` should be allowed (clicking
          the "alert me" button should trigger)
        </li>
        <li>➕</li>
        <li>
          ✅ should be able to dismiss `Popover` when interacting
          ...
          <span style={{ fontWeight: 600 }}>
            unless specified (ie. change color button)
          </span>
        </li>
        <li style={{ marginLeft: 30 }}>
          ✅ focus should <span style={{ fontWeight: 600 }}>NOT</span>{" "}
          return to the open button when unmounted, natural focus
          should occur
        </li>
      </ul>
      ...
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <button
          ...
          onClick={() =>
            setColor((prevColor) =>
              prevColor === "royalblue" ? "tomato" : "royalblue"
            )
          }
        >
          Change color
...
export const PopoverNonModal = () => (
  <div style={{ height: "300vh", fontFamily: SYSTEM_FONT }}>
    ...
    <ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
      ...
      <li style={{ marginLeft: 30 }}>
        ✅ focus should <span style={{ fontWeight: 600 }}>NOT</span>{" "}
        return to the open button when unmounted, natural focus should
        occur
      </li>
      <li>
      ...
      <li style={{ marginLeft: 30 }}>
        ❓ focus should move to next tabbable element after open
        button
        <div style={{ fontWeight: 600 }}>
          <span style={{ marginLeft: 20 }}>notes:</span>
          <ul>
            <li>
              I have left this one out for now as I am still unsure in
              which case it should do this
            </li>
            <li>
              for the moment, focus will be returned to the open
              button when `FocusScope` unmounts
            </li>
            <li>
              Need to do some more thinking, in the meantime, I think
              this behavior is ok
            </li>
          </ul>
        </div>
...
export const PopoverInDialog = () => (
  <div style={{ height: "300vh", fontFamily: SYSTEM_FONT }}>
    ...
    <ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
      ...
      <li>
        ✅ dismissing `Popover` by clicking outside should also
        dismiss `Dialog`
      </li>
    </ul>
...
export const PopoverNested = () => (
  <div style={{ height: "300vh", fontFamily: SYSTEM_FONT }}>
    ...
    <ul style={{ listStyle: "none", padding: 0, marginBottom: 30 }}>
      <li>
        ✅ dismissing a `Popover` by pressing escape should only
        dismiss that given `Popover`, not its parents
      </li>
      <li>
        ✅ interacting outside the blue `Popover` should only dismiss
        itself and not its parents
      </li>
      <li>
        ✅ interacting outside the red `Popover` should dismiss itself
        and the black one
      </li>
      <li>✅ unless the click wasn't outside the black one</li>
      <li>
        ✅ when the blue `Popover` is open, there should be{" "}
        <span style={{ fontWeight: 600 }}>NO</span> text cursor above
        the red or black inputs
      </li>
      <li>
        ✅ when the red `Popover` is open, there should be a text
        cursor above the black input but not the one on the page
        behind
      </li>
    </ul>
...
function DummyPopover({
  ...
  const [skipUnmountAutoFocus, setSkipUnmountAutoFocus] =
    React.useState(false);
  const [open, setOpen] = React.useState(false);
  const openButtonRef = React.useRef(null);
  const ScrollContainer = preventScroll
    ? RemoveScroll
    : React.Fragment;
  const scrollLockWrapperProps = preventScroll
    ? { as: Slot }
    : undefined;

  return (
    <Popper.Popper>
      <Popper.PopperAnchor asChild>
        <button
          type="button"
          ref={openButtonRef}
          onClick={() => setOpen((prevOpen) => !prevOpen)}
