...
export const Styled = () => (
  <DialogPrimitive.Root>
    <DialogPrimitive.Trigger className={triggerClass()}>open</DialogPrimitive.Trigger>
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content className={contentDefaultClass()}>
        ...
        <DialogPrimitive.Close className={closeClass()}>close</DialogPrimitive.Close>
...
export const NonModal = () => (
  <>
    <DialogPrimitive.Root modal={false}>
      <DialogPrimitive.Trigger className={triggerClass()}>open (non-modal)</DialogPrimitive.Trigger>
      <DialogPrimitive.Portal>
        <DialogPrimitive.Overlay className={overlayClass()} />
        <DialogPrimitive.Content
...
export const Controlled = () => {
  ...
  return (
    <DialogPrimitive.Root open={open} onOpenChange={setOpen}>
      <DialogPrimitive.Trigger>{open ? 'close' : 'open'}</DialogPrimitive.Trigger>
      <DialogPrimitive.Portal>
        <DialogPrimitive.Overlay className={overlayClass()} />
        <DialogPrimitive.Content className={contentDefaultClass()}>
  ...
  <>
    ...
    >
      ...
      <div>
        ...
        <h2>Closed</h2>
        <DialogPrimitive.Root>
          <DialogPrimitive.Trigger className={triggerAttrClass()}>open</DialogPrimitive.Trigger>
          <DialogPrimitive.Portal>
            <DialogPrimitive.Overlay className={overlayAttrClass()} />
            <DialogPrimitive.Content className={contentAttrClass()}>
              <DialogPrimitive.Title>Title</DialogPrimitive.Title>
              <DialogPrimitive.Description>Description</DialogPrimitive.Description>
              <DialogPrimitive.Close className={closeAttrClass()}>close</DialogPrimitive.Close>
            </DialogPrimitive.Content>
          </DialogPrimitive.Portal>
        </DialogPrimitive.Root>
