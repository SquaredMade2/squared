...
export class WorkspaceService extends RPCContextClient {
   ...
   */
  removeUserFromWorkspace(ctx: Context, req: RemoveUserFromWorkspaceRequest): Promise<void> {
   ...
   */
  inviteToWorkspace(ctx: Context, req: InviteToWorkspaceRequest): Promise<void> {
