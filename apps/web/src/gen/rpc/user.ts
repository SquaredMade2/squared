...
export class UserService extends RPCContextClient {
   ...
   */
  getDefaultWorkspace(ctx: Context, req: GetDefaultWorkspaceRequest): Promise<GetDefaultWorkspaceResponse> {
   ...
   */
  isUserAuthorized(ctx: Context, req: IsUserAuthorizedRequest): Promise<IsUserAuthorizedResponse> {
