...
export type DeleteRetrospectiveItemRequest = {
	retrospectiveItemId: string;
};

export type DeleteRetrospectiveItemResponse = {
	success: boolean;
};
...
export class SprintService extends RPCContextClient {
	...
	/**
	 * deleteRetrospectiveItem method
	 */
	deleteRetrospectiveItem(
		ctx: Context,
		req: DeleteRetrospectiveItemRequest,
	): Promise<DeleteRetrospectiveItemResponse> {
		return this.request(ctx, "deleteRetrospectiveItem", req);
	}
}
