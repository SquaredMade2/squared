...
export class SprintService extends RPCContextClient {
   ...
   * updateSprint method
   */
  updateSprint(ctx: Context, req: UpdateSprintRequest): Promise<UpdateSprintResponse> {
   ...
   */
  initializeSprints(ctx: Context, req: InitializeSprintsRequest): Promise<InitializeSprintsResponse> {
   ...
   */
  likeRetrospectiveItem(ctx: Context, req: LikeRetrospectiveItemRequest): Promise<LikeRetrospectiveItemResponse> {
