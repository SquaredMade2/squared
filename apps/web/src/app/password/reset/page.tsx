...
export default function ResetPasswordRequest() {
  ...
  return (
    <div className="w-full flex items-center h-[100vh] bg-[#141414]">
      <div className="flex flex-1 flex-col justify-center space-y-6 px-20 py-16 max-w-fit mx-auto bg-gradient-to-b from-[#17181c] to-[#23293b] align-middle rounded-lg">
        ...
        <div className="sm:mx-auto sm:w-[90%]">
          <h2 className="text-sm text-[#9597ad] text-center">
            Enter your email so we could send you instructions
          </h2>
        </div>
