...
export default function WorkspaceSettings() {
	...
	const { watch, setValue, ...formProps } = form;
							...
							<FormItem className="col-span-1">
								...
								<FormControl>
									{hasDomainManagePermission ? (
										...
										<div className="rounded-md border border-input bg-transparent px-3 py-2 text-sm">
											{workspace?.name}
										</div>
									)}
								</FormControl>
								...
								<FormControl>
									<div className="flex">
										{hasDomainManagePermission ? (
											...
											<div className="rounded-md border border-input bg-transparent px-3 py-2 text-sm">
												<span>
													https://app.squaredmade.com/{organization.name}
												</span>
												<span className="ml-0 rounded-l-md pl-0 focus-visible:ring-0 focus-visible:ring-offset-0"></span>
											</div>
										)}
									</div>
								</FormControl>
