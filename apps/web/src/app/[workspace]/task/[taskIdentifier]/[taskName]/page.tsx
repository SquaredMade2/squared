...
import type { Status, Task, Workspace } from "@squared/db";
...
const TaskPageContent = ({
	...
	setIsSubtasksExpanded: (expanded: boolean) => void;
	handleSubtaskStatusChange: (subtaskId: string, newStatus: string) => void;
}) => (
			...
			{isLoading || !task ? (
				...
				<ErrorBoundary>
					<TaskPageContent
						...
						setIsSubtasksExpanded={setIsSubtasksExpanded}
