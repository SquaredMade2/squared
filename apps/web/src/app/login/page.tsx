...
const styles = {
	...
	signUp:
		"font-semibold leading-6 text-[#5d76c9] hover:text-indigo-500 hover:cursor-pointer",
	googleBtn:
	...
	githubBtn:
		"flex w-full justify-center rounded-md bg-black px-3 py-2 text-sm font-semibold leading-6 text-foreground shadow-sm hover:bg-indigo-500 hover:cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mt-4",
};
