...
const GithubSettings: React.FC = () => {
	...
	const handleClick = (): void => {
		...
		router.push(
			`https://github.com/login/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_GITHUB_CLIENT_ID}&redirect_uri=${process.env.NEXT_PUBLIC_GITHUB_REDIRECT_URI}&scope=repo,user&state=${user.id}`,
		);
	};
