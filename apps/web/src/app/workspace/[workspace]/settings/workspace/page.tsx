...
const styles = {
	...
	container:
		"h-full w-full flex flex-col items-center bg-background text-foreground pt-20",
	dialog:
	...
	logoWrapper:
		"flex items-center justify-center w-16 h-16 bg-green-500 my-10 text-xl",
...
export default function WorkspaceSettings() {
	...
	const userHasAccess =
		access && access.id === user?._id && workspaceUrl === workspace.url;
