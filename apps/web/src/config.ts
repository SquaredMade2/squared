...
const { NEXT_PUBLIC_SERVER, NEXT_PUBLIC_URL, VERCEL_TARGET_ENV, VERCEL_URL } =
	process.env;
...
if (!VERCEL_TARGET_ENV) {
	throw new Error("Missing VERCEL_TARGET_ENV environment variable");
}
if (!VERCEL_URL) {
