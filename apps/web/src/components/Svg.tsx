...
const styles = {
	assigneeButton:
		"absolute right-4 top-4 h-5 w-5 rounded-full flex items-center justify-center text-foreground text-tiny cursor-pointer hover:scale-110 transition-all",
	unassignButtonInDropdown:
		"h-5 w-5 mx-1 mr-2 rounded-full flex items-center justify-center text-foreground text-tiny my-2",
};
...
export const additionIcon = (theme: string) => {
	...
	if (theme === "light")
		styles = "w-6 stroke-[#858699] duration-200 group-hover:stroke-black";
	return (
