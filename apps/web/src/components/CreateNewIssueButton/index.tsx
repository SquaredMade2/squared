...
const styles = {
	buttonDark:
		"w-24 bg-blueButton cursor-pointer text-foreground text-xs font-bold py-2 px-2.5 rounded-md mr-5 mt-2.5 mb-2.5 transition ease-out duration-200",
	buttonLight:
		"w-24 bg-blueButton cursor-pointer text-foreground text-xs font-bold py-2 px-2.5 rounded-md mr-5 mt-2.5 mb-2.5 transition ease-out duration-200",
};
