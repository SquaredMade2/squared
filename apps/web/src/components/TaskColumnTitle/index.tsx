...
const style = {
  ...
  subTitleSpacing:
    "flex flex-row w-full justify-between bg-muted dark:bg-accent rounded px-2 h-10 mb-2 font-bold",

  subTitleSpacingList:
    "flex w-full bg-muted dark:bg-accent items-center justify-between rounded-t xs:px-5 sm:px-5 lg:px- py-2 font-medium transition-all",
