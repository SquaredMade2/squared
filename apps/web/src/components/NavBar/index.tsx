    ...
    <div className={styles.main}>
      <div className={styles.mainContainer}>
        ...
        <div className={styles.teamsWrapper}>
          ...
          <Accordion type="single" collapsible className={styles.ul}>
            {workspace?.teams.map((team: Team) => {
              return (
                <AccordionItem key={team._id} value={team._id} className={styles.listWrapper}>
                  <AccordionTrigger className={styles.teamRow}>
                    <div className={styles.teamSVG}>
                      <TeamIcon />
                    </div>
                    <span className={styles.teamButton}>{team.name}</span>
                  </AccordionTrigger>
                  <AccordionContent>
                    <NavBarTeams
                      id={team._id}
