const toolbarStyles = {
  toolbar:
    "relative flex justify-evenly items-center mb-[1px] bg-background p-1 w-full z-99",
  inactiveToolbarItem:
  ...
  dropdownText:
    "flex flex-grow w-[200px] cursor-pointer hover:text-foreground ",
  dropdownItem:
    "mx-[8px] p-[8px] cursor-pointer text-foreground bg-transparent flex items-center justify-between rounded-sm min-w-[268px] rounded-lg hover:bg-blue-500 hover:text-foreground",
