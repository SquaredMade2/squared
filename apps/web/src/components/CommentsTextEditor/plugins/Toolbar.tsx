...
export function positionEditorElement(
	...
	if (rect === null) {
		editor.className = "opacity-0 top-[-10000px] left-[-10000px]";
	} else {
...
function BlockOptionsDropdownList({
	...
	return (
		<div
			className="z-10 absolute flex flex-col p-[8px] mx-[8px] shadow-lg rounded-lg min-h-[40px] bg-card"
			ref={dropDownRef}
		>
			<button
				type="button"
			...
			>
				<span className="flex flex-grow w-[200px] cursor-pointer hover:text-foreground ">
					Normal
				</span>
...
export default function ToolbarPlugin() {
	...
	return (
		<div
			className="relative flex justify-evenly items-center mb-[1px] bg-background p-1 w-full z-99"
			ref={toolbarRef}
		>
			{supportedBlockTypes.has(blockType) && (
				<>
					...
					>
						<div className="flex justify-evenly w-[100px] items-center">
