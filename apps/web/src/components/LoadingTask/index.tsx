...
const styles = {
	...
	sideNavWrapper:
		"relative max850:hidden transition-all duration-300 ease-in-out",
	leftSide:
		"w-full snap-start overflow-x-hidden flex flex-col mr-1 max850:mr-1 md:mr-5 xl:mr-10",
	taskStats:
		"h-92 mt-5 text-muted-foreground p-5 rounded-lg flex flex-col gap-8 bg-popover",
};
