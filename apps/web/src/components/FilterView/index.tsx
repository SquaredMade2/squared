...
const styles = {
	homeBg:
		"flex flex-col w-[calc(100%-0px)] h-screen bg-skin-fillHome overflow-auto",
	subTitleContainer:
	...
	taskSubtitlesCon:
		"flex h-[100px] items-center border-t border-border gap-[18px]",
};
