    ...
    <>
      <div
        className={`absolute z-50 top-full left-0 w-72 transition-all duration-300 ${
          showFilterDropDown ? "h-10 opacity-100" : "h-0 opacity-0"
        }`}
      >
        <Combobox
          value={filterOption}
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <Combobox.Input
                  className="absolute pl-1 h-full w-full bg-card z-50 inset-y-0 right-0 flex items-center pr-2 focus-visible:outline-none"
