...
const SelectIsOrIsNotDropDownIs = ({
	...
	const mouseDistanceToLeft = Math.abs(
		hookCurrentMousePosition.x - isIsNotLocation.left,
	);
	const mouseDistanceToTop = Math.abs(
		hookCurrentMousePosition.y - isIsNotLocation.top,
	);
	const mouseDistanceToRight = Math.abs(
		hookCurrentMousePosition.x - isIsNotLocation.right,
	);
	const mouseDistanceToBottom = Math.abs(
		hookCurrentMousePosition.y - isIsNotLocation.bottom,
	);
