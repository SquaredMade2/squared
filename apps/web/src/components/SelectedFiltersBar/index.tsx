	...
	return (
		<>
			<div className="grid grid-cols-6 h-full text-foreground border-border bg-card border-t">
				...
				<div className="flex justify-end pr-5 text-foreground bg-card col-span-2">
					<p className="mt-[7px] text-muted-foreground">
						Showing issues that match
						<select
							title="Title"
							className="mx-2 px-1 bg-card border border-border rounded-md text-muted-foreground cursor-pointer select-no-arrow"
					...
					<button
						type="button"
						className="flex mt-[7px] h-5 items-center ml-1.5 cursor-pointer border p-3 rounded border-border bg-background hover:bg-accent"
