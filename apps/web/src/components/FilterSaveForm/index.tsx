...
const styles = {
	...
	titleInput:
		"w-full h-full bg-card caret-slate-400 text-foreground focus-visible:outline-none",
	...
	createButton:
		"rounded border border-secondary bg-background p-0.5 mr-6 cursor-pointer",
	leftSide: "flex items-center text-foreground ml-2",
	firstButton:
		"flex items-center p-1 border rounded-l border-border bg-background",
	...
	fourthButton:
		"flex items-center p-1 border rounded-r border-border bg-background",
