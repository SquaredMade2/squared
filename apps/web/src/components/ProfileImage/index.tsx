...
const styles = {
  ...
  taskCard:
    "absolute right-4 top-4 h-5 w-5 rounded-[5px] bg-[#3B81F6] flex items-center justify-center text-white text-tiny",
  assigneeDropdown:
    "h-5 w-5 mx-1 mr-2 rounded-[5px] bg-[#3B81F6] flex items-center justify-center text-white text-tiny my-2",
  activityItem:
    "h-5 w-5 mx-1 mr-2 rounded-full bg-purpleButtonHover flex items-center justify-center text-white text-tiny my-2",
  searchCommand:
    "size-[18px] rounded-[5px]   bg-[#3B81F6] flex items-center justify-center text-white text-tiny",
};
