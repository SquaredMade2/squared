...
import type { Author, TaskEvent } from "@/interfaces/event.interfaces";
...
export const updateComment =
	(id: string, comment: string) => async (dispatch: Dispatch<Action>) => {
		try {
...
export const clearTaskEventLog =
	(clearedTaskEventLog: TaskEventLog) => async (dispatch: Dispatch<Action>) => {
		dispatch({
