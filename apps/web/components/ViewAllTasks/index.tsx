...
const style = {
  tasksBackgroundGrid:
    'flex flex-row h-full overflow-y-hidden w-full snap-start overflow-x-scroll custom-scrollbar',
  tasksBackgroundList:
    'flex flex-col w-full h-full overflow-y-scroll w-full scrollbar-thin-transparent',
};
