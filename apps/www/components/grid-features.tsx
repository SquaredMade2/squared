...
export const GridFeatures = () => {
	const features = [
		...
		},
		{
			...
			description:
				"If you do not like EveryAI, we will work with you to find a solution.",
...
const Feature = ({
	...
	return (
		...
		>
			{index < 4 && (
				<div className="opacity-0 group-hover:opacity-100 transition duration-200 group absolute inset-0 h-full w-full bg-gradient-to-t from-neutral-100 dark:from-background-dark to-transparent pointer-events-none" />
			)}
			{index >= 4 && (
				<div className="opacity-0 group-hover:opacity-100 transition duration-200 group absolute inset-0 h-full w-full bg-gradient-to-b from-neutral-100 dark:from-background-dark to-transparent pointer-events-none" />
			)}
