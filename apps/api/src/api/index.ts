...
import * as $f1fea0 from "./team/[teamId]/sprints/[sprintId]/tasks";
...
export type AllRouteDeps =
  & Parameters<typeof $0daf92.createRoute>[0]
  ...
  & Parameters<typeof $f1fea0.createRoute>[0]
...
export function createApiRouter(router: Router, deps: AllRouteDeps) {
...

  {
    ...
    router.delete("/api/workspace/:workspaceId/label", toQueryHandler(r.DELETE));
  }

  {
    ...
    router.post("/api/workspace/:workspaceId/invite", toMutationHandler(r.POST));
    router.put("/api/workspace/:workspaceId/invite", toMutationHandler(r.PUT));
    router.delete("/api/workspace/:workspaceId/invite", toQueryHandler(r.DELETE));
  }
...

  {
    ...
    router.post("/api/workspace/:workspaceId/filter", toMutationHandler(r.POST));
    router.put("/api/workspace/:workspaceId/filter", toMutationHandler(r.PUT));
    router.delete("/api/workspace/:workspaceId/filter", toQueryHandler(r.DELETE));
  }
...

  {
    ...
    const r: Route<Params> = $f1fea0.createRoute(deps);

    router.get("/api/team/:teamId/sprints/:sprintId/tasks", toQueryHandler(r.GET));
    router.post("/api/team/:teamId/sprints/:sprintId/tasks", toMutationHandler(r.POST));
    router.put("/api/team/:teamId/sprints/:sprintId/tasks", toMutationHandler(r.PUT));
    router.delete("/api/team/:teamId/sprints/:sprintId/tasks", toQueryHandler(r.DELETE));
  }

  {
    ...
    router.post("/api/team/:teamId/sprints/:sprintId", toMutationHandler(r.POST));
    router.put("/api/team/:teamId/sprints/:sprintId", toMutationHandler(r.PUT));
    router.delete("/api/team/:teamId/sprints/:sprintId", toQueryHandler(r.DELETE));
  }
